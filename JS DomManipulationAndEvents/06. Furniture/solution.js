function solve() {
  ...
  exerciseDiv.getElementsByTagName('button')[0].addEventListener('click', addFurniture);
  exerciseDiv.getElementsByTagName('button')[1].addEventListener('click', buyFurniture);
  let table = document.getElementsByClassName('table')[0];

  function addFurniture() {
    let textAreaGenerate = exerciseDiv.getElementsByTagName('textarea')[0];
